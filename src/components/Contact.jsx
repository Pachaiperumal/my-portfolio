        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 max-w-6xl mx-auto items-start">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                <div className="w-14 h-14 rounded-2xl bg-violet-100 dark:bg-violet-500/10 flex items-center justify-center mr-5 group-hover:bg-violet-200 dark:group-hover:bg-violet-500/20 transition-all">
                  <Mail className="text-violet-600 dark:text-violet-400 group-hover:scale-110 transition-transform" size={24} />
                </div>
                <div>
                  <p className="text-slate-600 dark:text-slate-400 text-sm font-medium mb-1 transition-colors duration-500">Email</p>
                  <a href="mailto:pachaiperumal591813@gmail.com" className="text-base md:text-lg font-bold text-slate-900 dark:text-white hover:text-violet-500 dark:hover:text-violet-400 transition-colors">
              ...
              <motion.div
                ...
                className="flex items-center group glass p-4 rounded-3xl border border-white/5 hover:border-violet-500/30 transition-colors shadow-lg"
              >
                <div className="w-14 h-14 rounded-2xl bg-fuchsia-100 dark:bg-fuchsia-500/10 flex items-center justify-center mr-5 group-hover:bg-fuchsia-200 dark:group-hover:bg-fuchsia-500/20 transition-all">
                  <Phone className="text-fuchsia-600 dark:text-fuchsia-400 group-hover:scale-110 transition-transform" size={24} />
                </div>
                <div>
                  <p className="text-slate-600 dark:text-slate-400 text-sm font-medium mb-1 transition-colors duration-500">Phone</p>
                  <a href="tel:9080414539" className="text-base md:text-lg font-bold text-slate-900 dark:text-white hover:text-fuchsia-500 dark:hover:text-fuchsia-400 transition-colors">
                    9080414539
                  </a>
                </div>
              </motion.div>
            ...
            <div className="pt-6">
              ...
              <div className="flex space-x-4">
                {[
                  { Icon: Github, href: "https://github.com/Pachaiperumal" },
                  { Icon: Linkedin, href: "https://www.linkedin.com/in/pachaiperumal-a-64079629a/" },
                  { Icon: SiWhatsapp, href: "https://wa.me/919080414539" }
                ].map((social, i) => (
                  <motion.a
                    key={i}
                    href={social.href}
              ...
              <form className="space-y-6 relative z-10" onSubmit={(e) => e.preventDefault()}>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-slate-700 dark:text-slate-300 ml-1 tracking-wide transition-colors duration-500">Name</label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-slate-700 dark:text-slate-300 ml-1 tracking-wide transition-colors duration-500">Email</label>
                    <input
                      type="email"
                      className="w-full bg-slate-100/60 dark:bg-slate-900/60 backdrop-blur-md border border-slate-200 dark:border-white/10 rounded-2xl px-5 py-4 text-slate-900 dark:text-white focus:outline-none focus:border-violet-500 dark:focus:border-violet-500 focus:bg-slate-50 dark:focus:bg-slate-900/80 focus:ring-1 focus:ring-violet-500/50 transition-all placeholder:text-slate-400 dark:placeholder:text-slate-600 shadow-inner"
                ...
                <div className="space-y-2">
                  <label className="text-sm font-semibold text-slate-700 dark:text-slate-300 ml-1 tracking-wide transition-colors duration-500">Message</label>
                  <textarea
                    rows="5"
