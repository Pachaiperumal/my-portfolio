    ...
    <section id="about" className="py-24 relative overflow-hidden bg-slate-50 dark:bg-[#0B1120] transition-colors duration-500">
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-7xl">
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          {/* Left Text Column */}
          <motion.div
            initial={isMobile ? false : { opacity: 0, x: -30 }} // softer x movement
          ...
          >
            <div className="relative">
              ...
              />
              <p className="poppins-light text-xl text-slate-700 dark:text-slate-300 font-light max-w-[520px] leading-[1.7] transition-colors duration-500">
                Hi! I'm <strong className="text-slate-900 dark:text-white font-medium">Pachai Perumal A</strong>, a dedicated <strong className="text-slate-900 dark:text-white font-medium">Full Stack Developer</strong> with expertise in the <span className="text-violet-500 dark:text-violet-400 font-medium">MERN stack</span>.
            ...
            <p className="poppins-light text-lg text-slate-600 dark:text-slate-400 max-w-[520px] leading-[1.7] transition-colors duration-500">
          ...
          >
            ...
            >
              ...
              <div className="relative h-full glass p-8 md:p-10 rounded-[23px] border border-white/5 transition-all duration-500 overflow-hidden">
                ...
                <h3 className="montserrat-bold text-2xl flex items-center mb-8 relative z-10 text-slate-900 dark:text-white transition-colors duration-500">
                  <div className="w-12 h-12 rounded-full bg-violet-100/50 dark:bg-violet-500/20 flex items-center justify-center mr-4 transition-colors duration-500">
                ...
                <div className="relative pl-8 md:pl-10 pb-4">
                  ...
                  <div className="relative z-10">
                    <div className="absolute -left-[37px] md:-left-[45px] top-1.5 w-5 h-5 rounded-full bg-slate-50 dark:bg-slate-900 border-[3px] border-violet-500 shadow-[0_0_15px_rgba(139,92,246,0.6)] transition-colors duration-500" />

                    <div className="glass bg-slate-100/40 dark:bg-slate-900/40 p-6 rounded-2xl border border-slate-200 dark:border-white/5 hover:border-slate-300 dark:hover:border-white/10 transition-colors transform transition-transform group-hover:translate-x-2 duration-300">
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 mb-3">
                        <h4 className="roboto-slab-regular text-xl font-bold text-slate-900 dark:text-white transition-colors duration-500">Bachelor of Computer Applications</h4>
                        <div className="px-3 py-1 rounded-full bg-violet-100 dark:bg-violet-500/20 text-violet-600 dark:text-violet-300 text-xs font-bold border border-violet-200 dark:border-violet-500/30 whitespace-nowrap w-fit transition-colors duration-500">
                          2022 – 2025
                        </div>
                      </div>

                      <p className="text-violet-600 dark:text-violet-400 font-medium mb-4 text-base transition-colors duration-500">Jawahar Science College</p>

                      <div className="flex flex-wrap items-center gap-4 text-sm text-slate-600 dark:text-slate-400 bg-slate-200/50 dark:bg-black/20 p-3 rounded-xl w-fit transition-colors duration-500">
                        <span className="flex items-center"><BookOpen size={14} className="mr-2 text-slate-500" /> Major in CS</span>
                        <div className="w-1 h-1 rounded-full bg-slate-400 dark:bg-slate-600 transition-colors duration-500" />
            ...
            >
              <div className="bg-slate-50 dark:bg-slate-950 rounded-[23px] p-8 md:p-10 relative overflow-hidden flex items-center justify-center transition-colors duration-500">
                <p className="merriweather-bold text-lg md:text-xl italic text-slate-700 dark:text-slate-300 text-center leading-relaxed max-w-xl transition-colors duration-500">
